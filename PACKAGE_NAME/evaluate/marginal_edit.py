...
def calculate_marginal_bias(obs_data: np.ndarray, metrics: list = [], remove_outliers: bool = True, **cm_data) -> pd.DataFrame:
    ...
    **cm_data :
    ...
    for cm_data_key, cm_data in cm_data.items():
        ...
        elif (remove_outliers ==True) and np.any(mean_bias > 1000):
