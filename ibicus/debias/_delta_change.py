...
class DeltaChange(Debiaser):
    ...
    **Examples:**
    ...
    running_window_mode : bool
        Iteration: Whether DeltaChange is used in running window mode to account for seasonalities. If ``running_window_mode = False`` then DeltaChange is applied on the whole period. Default: ``True``.
